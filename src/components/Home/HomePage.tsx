    ...
    <div style={{
        ...
        >
          {[0, 1, 2].map(i => (
            <span key={i} style={{
              ...
              background: '#fff', borderRadius: '2px', transition: 'all 0.2s',
      ...
      {menuOpen && (
        <div style={{
          ...
          background: '#1a1a2e', borderTop: '1px solid rgba(255,255,255,0.1)', padding: '0.5rem 0'
        }}>
          {[
            { label: '🏠 Home', id: 'home' },
            ...
            <button key={item.id} onClick={() => scrollTo(item.id)} style={{
              display: 'block', width: '100%', padding: '14px 1.5rem',
          ...
          <div style={{ padding: '12px 1.5rem' }}>
            <button onClick={() => { onGetStarted(); setMenuOpen(false) }} style={{
              width: '100%', padding: '13px', background: '#f6c90e',
      ...
      <div id="home" style={{
        ...
        <div style={{
          ...
          color: '#a8e063', letterSpacing: '0.8px', marginBottom: '1.25rem'
        }}>
          OUTDOOR KNOWLEDGE WORK RESEARCH · 2025
        </div>

        <h1 style={{ fontSize: '1.75rem', fontWeight: 800, color: '#fff', margin: '0 0 1rem', lineHeight: 1.3 }}>
          Where Do You Work<br />When You Work Outside?
        </h1>

        <p style={{
          fontSize: '14px', color: '#aab4be', lineHeight: 1.75,
          margin: '0 auto 1rem', maxWidth: '340px'
        }}>
          We are studying how people use <strong style={{ color: '#a8e063' }}>outdoor and semi-outdoor spaces</strong> —
          parks, terraces, courtyards, café patios — as places of knowledge work.
        </p>
        <p style={{
          fontSize: '13px', color: '#7a8a9a', lineHeight: 1.75,
          margin: '0 auto 2rem', maxWidth: '340px'
        }}>
        ...
        <button onClick={onGetStarted} style={{
          ...
          margin: '0 auto 12px', padding: '16px',
          background: '#f6c90e', color: '#1a1a2e', border: 'none',
          borderRadius: '12px', fontSize: '16px', fontWeight: 700,
          cursor: 'pointer', boxShadow: '0 4px 16px rgba(246,201,14,0.35)'
        }}>
          🚀 Participate Now
        </button>

        <button onClick={() => scrollTo('task')} style={{
          display: 'block', width: '100%', maxWidth: '320px',
        ...
        <div style={{
          ...
          {[
            ...
            <div key={i} style={{ textAlign: 'center' }}>
              <div style={{ fontSize: '18px', fontWeight: 700, color: '#f6c90e' }}>{s.value}</div>
      ...
      <div id="task" style={{ background: '#fff', padding: '2.5rem 1.25rem' }}>
        <div style={{ maxWidth: '480px', margin: '0 auto' }}>
          <h2 style={{ color: '#1a1a2e', fontSize: '1.25rem', margin: '0 0 0.4rem' }}>
            Your Task
          </h2>
          <p style={{ color: '#999', fontSize: '13px', margin: '0 0 1.5rem' }}>
            Simple — but please read carefully so your photo is useful for the research.
          </p>
          ...
          <div style={{
            ...
            <h3 style={{ margin: '0 0 8px', color: '#1a2e1a', fontSize: '15px' }}>
          ...
          <div style={{
            ...
            padding: '1rem 1.25rem', marginBottom: '1rem', border: '1px solid #eee'
          }}>
            <p style={{ margin: '0 0 10px', fontWeight: 600, fontSize: '13px', color: '#1a1a2e' }}>
              ✅ Good photo subjects
            </p>
            {[
              ...
              <div key={i} style={{ display: 'flex', gap: '8px', marginBottom: '7px', fontSize: '13px', color: '#444' }}>
          ...
          <div style={{
            background: '#fff8f8', borderRadius: '12px',
            padding: '1rem 1.25rem', marginBottom: '1.5rem', border: '1px solid #f5c0c0'
          }}>
            <p style={{ margin: '0 0 10px', fontWeight: 600, fontSize: '13px', color: '#1a1a2e' }}>
              ❌ Please avoid
            </p>
            {[
              ...
              <div key={i} style={{ display: 'flex', gap: '8px', marginBottom: '7px', fontSize: '13px', color: '#444' }}>
                <span style={{ color: '#e53e3e', fontWeight: 700, flexShrink: 0 }}>✗</span>{t}
              </div>
            ))}
          </div>

          {/* Steps */}
          <h3 style={{ color: '#1a1a2e', fontSize: '14px', margin: '0 0 1rem' }}>
          ...
          {[
            ...
            <div key={item.step} style={{
              ...
              padding: '0.9rem 1rem', background: '#f9f9f9',
              borderRadius: '12px', border: '1px solid #eee', marginBottom: '10px'
            }}>
              <div style={{ flex: 1 }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '3px' }}>
                  <span style={{
                    background: '#f6c90e', color: '#1a1a2e',
                    fontSize: '10px', fontWeight: 700, padding: '2px 7px', borderRadius: '6px'
                  }}>
                     {item.step}
                  </span>
                  <span style={{ fontWeight: 600, fontSize: '14px', color: '#1a1a2e' }}>{item.title}</span>
                </div> 
              </div>
            </div>
          ))}
      ...
      <div id="about" style={{ background: '#f0f4f0', padding: '2.5rem 1.25rem' }}>
        <div style={{ maxWidth: '480px', margin: '0 auto' }}>
          ...
          <p style={{ color: '#555', fontSize: '14px', lineHeight: 1.75, margin: '0 0 1.5rem' }}>
            ...
            elements — <strong>natural light, greenery, built structures, shelter, and sky</strong> —
            and combined with your short survey responses to build a picture of what
            outdoor workspaces actually look like in practice.
          </p>

          <div style={{ background: '#fff', borderRadius: '12px', padding: '1.25rem', border: '1px solid #ddd' }}>
            <p style={{ margin: '0 0 10px', fontWeight: 600, fontSize: '13px', color: '#1a1a2e' }}>
              ✅ What we collect
            </p>
            {[
      ...
      {/* ── CONSENT ── */}
      <div id="consent" style={{ background: '#fff', padding: '2.5rem 1.25rem' }}>
        <div style={{ maxWidth: '480px', margin: '0 auto' }}>
          <h2 style={{ color: '#1a1a2e', fontSize: '1.25rem', margin: '0 0 0.4rem' }}>
          ...
          {[
            ...
            <div key={i} style={{
              ...
              <div style={{ fontSize: '22px', flexShrink: 0, lineHeight: 1 }}>{item.icon}</div>
              <div>
                <p style={{ margin: '0 0 5px', fontWeight: 600, fontSize: '14px', color: '#1a1a2e' }}>{item.title}</p>
                <p style={{ margin: 0, fontSize: '13px', color: '#666', lineHeight: 1.6 }}>{item.text}</p>
              </div>
            </div>
          ))}
          ...
          <div style={{
            ...
            margin: '1.5rem 0', fontSize: '13px', color: '#7a5f00', lineHeight: 1.7
          }}>
            <strong>By logging in and submitting photos you confirm</strong> that you have
            read and understood the above, consent to your anonymised outdoor workspace
            photos and survey responses being used for academic research, and take
            responsibility for censoring any sensitive content before submission.
          </div>
      ...
      {/* ── FOOTER ── */}
      <div style={{
        background: '#1a2e1a', color: '#666', textAlign: 'center',
        padding: '1.5rem 1.25rem', fontSize: '12px', lineHeight: 1.7
      }}>
        ...
        <p style={{ margin: 0 }}>
          Questions? Reply to your invitation email.
        </p>
      </div>
