    ...
    <div style={{
      ...
      <div style={{
        ...
        <h1 style={{
          ...
          fontWeight: 800, margin: '0 0 0.5rem', textAlign: 'center'
        }}>
          Participant Login
        </h1>
        <p style={{
          color: '#aab4be', fontSize: '14px', textAlign: 'center',
          margin: '0 0 2rem', maxWidth: '280px', lineHeight: 1.6
        }}>
          Enter the participant ID sent to you by the research team in your invitation email.
        </p>
        ...
        <div style={{
          ...
          <label style={{
            ...
            color: '#555', letterSpacing: '0.05em', marginBottom: '8px'
          }}>
            PARTICIPANT ID
          </label>
          ...
          {error && (
            <div style={{
              ...
              color: '#e53e3e', fontSize: '13px', marginBottom: '12px'
            }}>
              <span>⚠</span> {error}
            </div>
          )}
          ...
          {!error && (
            <p style={{
              ...
              Your ID is 2–10 characters, e.g. <strong>P007</strong> or <strong>PART12</strong>.
              Check your invitation email if unsure.
            </p>
          )}
...
>
  {loading ? 'Checking...' : 'Continue →'}
        ...
        <p style={{
          ...
          color: '#5a6a7a', textAlign: 'center', maxWidth: '280px', lineHeight: 1.6
        }}>
          Don't have an ID? You need an invitation from the research team to participate.
        </p>
      </div>
    </div>
  )
